...
<body>
    ...
    <main>
        ...
        <form id="pengumumanForm" action="" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" name="action" value="add">Tambah Pengumuman</button>
        </form>
        <?php
        } elseif (isset($_GET['action']) && $_GET['action'] == 'edit' && isset($_GET['id'])) {
            $id_pengumuman = $_GET['id'];
            $editQuery = "SELECT * FROM pengumuman WHERE id_pengumuman=?";
        ...
        <body>
            ...
            <main class="coba">
                ...
                <form id="editForm" action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="id_pengumuman" value="<?php echo $editRow['id_pengumuman']; ?>">
